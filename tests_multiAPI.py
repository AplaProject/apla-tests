...
class MultiTxApiTestCase(unittest.TestCase):
    ...
    def test_new_interface_block(self):
        ...
        data = [{"Name": block, "Value": "Hello page!", "ApplicationId": "1",
                "Conditions": "true"}]
        res = self.callMulti("NewBlock", data)

    def test_new_interface_block_multi(self):
        block = "Block_" + utils.generate_random_name()
        data = [{"Name": "Block_"+ utils.generate_random_name(), "Value": "Hello page!", "ApplicationId": "1",
