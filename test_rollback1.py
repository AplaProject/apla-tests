...
class TestRollback1():
    ...
    def call(self, name, data, setup_vars):
        ...
        res = actions.tx_status(url, setup_vars["wait"],
                             resp['hash'], token)
        return res
    ...
    def create_contract(self, data):
        ...
        if data == "":
            ...
            dataC = data
        res = self.call("NewContract", dataC, setup_vars())
        return name, code
    ...
    def add_binary(self, setup_vars):
    ...
    def insert_to_user_table(self, tableName):
        ...
        res = self.call(name, data, setup_vars())
    ...
    def edit_contract(self, contract, code):
        ...
        res = self.call("EditContract", data2, setup_vars())

    def activate_contract(self, name):
        data = {"Id": actions.get_contract_id(url, name, token)}
        res = self.call("ActivateContract", data, setup_vars())

    def deactivate_contract(self, name):
        data = {"Id": actions.get_contract_id(url, name, token)}
        res = self.call("DeactivateContract", data, setup_vars())
    ...
    def edit_parameter(self, name):
        ...
        res = self.call("EditParameter", data, setup_vars())
