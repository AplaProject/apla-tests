...
class TestSimvolio():
    ...
    def assert_tx_in_block(self, result, jwtToken, setup_vars):
        ...
        status = actions.tx_status(url, setup_vars["wait"], result['hash'], jwtToken)
        print(status)
    ...
    def create_contract(self, code):
        ...
        result = actions.call_contract(url, prKey, "NewContract",
                                       data, token)
        self.assert_tx_in_block(result, token, setup_vars())
    ...
    def check_contract(self, sourse, checkPoint, setup_vars):
        ...
        hash = res["hash"]
        result = actions.tx_status(url, setup_vars["wait"], hash, token)
    ...
    def call(self, name, data, setup_vars):
        ...
        status = actions.tx_status(url, setup_vars["wait"], result['hash'], token)
        return status

    def check_contract_with_data(self, sourse, data, checkPoint, setup_vars):
        code, name = self.generate_name_and_code(sourse)
        self.create_contract(code)
        url = self.config["2"]["url"]
        prKey = self.config["1"]['private_key']
    ...
    def test_contract_db_find(self):
        ...
        self.check_contract(contract["code"], contract["asert"], setup_vars())
    ...
    def test_contract_langRes(self, setup_vars):
        data = {"ApplicationId": 1,
                "Name": "test",
                "Trans": "{\"en\": \"test_en\", \"de\" : \"test_de\"}"}
        result = actions.call_contract(url, prKey, "NewLang", data, token)
        tx = actions.tx_status(url, setup_vars["wait"], result['hash'], token)
        contract = self.contracts["langRes"]
        self.check_contract(contract["code"], contract["asert"], setup_vars())

    def test_contract_dbInsert(self, setup_vars):
    ...
    def test_contract_dbUpdate(self, setup_vars):
        columns = """[{"name":"name","type":"varchar",
        "index": "1",  "conditions":"true"},
        {"name":"test","type":"varchar",
        "index": "0",  "conditions":"true"}]"""
    ...
    def test_contracts_dbUpdateExt(self, setup_vars):
        columns = """[{"name":"name","type":"varchar",
        "index": "1",  "conditions":"true"},
        {"name":"test","type":"varchar",
        "index": "0",  "conditions":"true"}]"""
    ...
    def test_sys_var_role_id_readonly(self, setup_vars):
        sysVarName = "$role_id"
    ...
    def test_z1_dbSelectMetricsMin(self, setup_vars):
        ...
        self.check_contract(contract["code"], str(ecosystem_tx), setup_vars())
    ...
    def test_z2_dbSelectMetricsMax(self):
        ...
        self.check_contract(contract["code"], str(ecosystem_members), setup_vars())
    ...
    def test_z3_dbSelectMetricsAvg(self):
        ...
        self.check_contract(contract["code"], str(ecosystem_pages), setup_vars())
    ...
    def test_getHistoryContract(self):
        ...
        self.check_contract_with_data(contract["code"], data, replacedString, setup_vars())
    ...
    def test_getHistoryPage(self):
        ...
        contract = self.contracts["getHistory"]
        self.check_contract_with_data(contract["code"], data, page, setup_vars())
    ...
    def test_sys_var_stack(self):
        ...
        data = {"Wallet": "", "ApplicationId": 1,
                "Value": outerCode,
                "Conditions": "ContractConditions(`MainCondition`)"}
        res = self.call(outerName, data, setup_vars())
    ...
    def test_getHistoryRowMenu(self):
        ...
        self.check_contract_with_data(contract["code"], data, menu, setup_vars())
    ...
    def test_getHistoryRowBlock(self):
        ...
        contract = self.contracts["getHistoryRow"]
        self.check_contract_with_data(contract["code"], data, block, setup_vars())